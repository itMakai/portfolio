...
export default function MyPortfolio() {
  ...
  return (
    <section className="portfolio--section" id="MyPortfolio">
      {/* Header row */}
      <div ref={headerRef} className="portfolio--container-box scroll-reveal">
        <div className="portfolio--container">
          <p className="sub--title block">Selected Work</p>
      ...
      {/* Standard Grid for All Projects */}
      <div className="portfolio-standard-grid">
        {data?.portfolio?.map((item, index) => {
          ...
          return (
            <div
              ...
              className={`portfolio-modern-card scroll-reveal reveal-delay-${(index % 3) + 1}`}
            >
              <div className="portfolio-modern-img">
                <img src={item.src} alt={item.title} />
                {isLive && <span className="portfolio--live-badge">LIVE</span>}
                
                {/* Hover overlay content */}
                <div className="portfolio-modern-overlay">
