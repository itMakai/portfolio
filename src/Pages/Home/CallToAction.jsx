    ...
    <section className="cta--section" id="ready-to-work">
      <div className="cta--container scroll-reveal--scale" ref={containerRef}>
        ...
        <div className="cta--contact-cards">
          <a href="tel:+254115784503" className="cta--contact-card" aria-label="Call iTsoftMak Solutions directly">
          ...
          <a href="mailto:itsoftmak@gmail.com" className="cta--contact-card" aria-label="Email iTsoftMak Solutions Sales and Support">
            <div className="cta--icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
